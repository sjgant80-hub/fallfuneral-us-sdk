...
**FallFuneral · sovereign single-file US funeral director OS** — sovereign SDK extracted from `fallfuneral-us/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallfuneral-us-sdk
```

## Use
```js
import * as fallfuneral-us from '@ai-native-solutions/fallfuneral-us-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallfuneral-us-sdk/
- MCP wrapper: [`@ai-native-solutions/fallfuneral-us-mcp`](https://github.com/sjgant80-hub/fallfuneral-us-mcp)
- HTTP API: [`@ai-native-solutions/fallfuneral-us-api`](https://github.com/sjgant80-hub/fallfuneral-us-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallfuneral-us-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallfuneral-us-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallfuneral-us-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallfuneral-us-sdk -- npx -y @ai-native-solutions/fallfuneral-us-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallfuneral-us-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallfuneral-us-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallfuneral-us-sdk/
- **Source**: https://github.com/sjgant80-hub/fallfuneral-us-sdk
